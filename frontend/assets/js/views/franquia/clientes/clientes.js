...
var qv_submodulo_nome = 'Clientes';
var qv_submodulo_slug = 'clientes';
				...
				Swal.fire({
					...
					if(result.value) {
						...
						$.ajax({
							type: 'POST',
							dataType : "json",
							data: 	'acao=deletarCliente&idCliente='+idCliente+'&qv_url_path='+qv_url_path,
				...
				Swal.fire({
                    ...
                    if(result.value) {
                        ...
                        $.ajax({
                            ...
                            url: '/app/controllers/franquia/clientes/ajax.php',
                            success: function(retorno){
...
var qv_aniversariantes = function() {
	return {
		init: function() {
			...
			var table = $('#responsive-datatable').DataTable({
				...
				"stateSave": false,
				"ajax": {
					"url": "/app/models/"+qv_modulo_slug+"/"+qv_submodulo_slug+"/DT_aniversariantes.php",
					"data": function (d) {
						//d.tipo    = $('#LV_produtosVitrine_Tipo').val();
						//d.dataDe    = $('#dataDe').val();
						//d.dataAte   = $('#dataAte').val();
