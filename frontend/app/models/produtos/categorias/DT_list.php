...
$queryDataDelete = ' C.dataDelete IS NULL ';
...
$sql = "SELECT C.idCategoria AS ID_REGISTRO, C.nome AS NOME, C.slug AS SLUG, C.codigo AS CODIGO, C.status AS STATUS";
$sql.= " FROM produtosCategorias C ";
$sql.= " WHERE ";
$sql.= $queryFinal;
//echo $sql;
...
if(!empty($requestData['search']['value'])) {   // if there is a search parameter, $requestData['search']['value'] contains search parameter
    ...
    $sql.=" OR C.codigo LIKE '%".$requestData['search']['value']."%' ";
    $sql.=" OR C.status LIKE '%".$requestData['search']['value']."%' ) ";
}
            ...
            <div class="drodown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <ul class="link-list-opt no-bdr">
                        <li><a href="/produtos/categorias/update/'.$row["ID_REGISTRO"].'" class=""><em class="icon ni ni-pen2"></em><span>Editar</span></a></li>
