...
/* /produtos/imposto/list.twig */
class __TwigTemplate_30d90272eca9b3730c0afca8ce7543d0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"nk-content-inner\">
            ...
            <div class=\"nk-block-head nk-block-head-sm\">
                <div class=\"nk-block-between\">
                    <div class=\"nk-block-head-content\">
                        <h3 class=\"nk-block-title page-title\">Produtos / Impostos / <strong class=\"text-primary small\">Consulta</strong></h3>
                        <div class=\"nk-block-des text-soft\">
                            <p>Tela para consulta de impostos dos produtos.</p>
                        </div>
        ...
        echo "/create\" class=\"btn btn-white btn-outline-light w-xs-100 d-inline\"><em class=\"icon ni ni-plus-circle\"></em><span>Criar Novo Imposto</span></a></li>
                                </ul>
                            </div>
                        </div><!-- .toggle-wrap -->
                    </div><!-- .nk-block-head-content -->
                                ...
                                <table class=\"table-hover nowrap nk-tb-list w-100 general-datatable\" data-auto-responsive=\"false\" >
                                    <thead class=\"head-table\">
                                        <tr class=\"nk-tb-item nk-tb-head\">
                                            ...
                                            <th class=\"nk-tb-col text-center\">PERCENTUAL</th>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["imposto"]) {
            ...
            // line 47
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["imposto"], "name", [], "any", false, false, false, 47));
            echo "</td>
                                                <td class=\"nk-tb-col text-center\">";
            // line 48
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["imposto"], "percentage", [], "any", false, false, false, 48));
            echo " %</td>
                                                    ...
                                                    <div class=\"dropdown\">
                                                        ...
                                                        <div class=\"dropdown-menu dropdown-menu-xs\">
                                                                <ul class=\"link-list-plain\">
                                                                    <li><a href=\"/produtos/imposto/update/";
            // line 54
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["imposto"], "id", [], "any", false, false, false, 54));
            echo "\" class=\"text-primary\">Editar</a></li>
                                                                    <li><a href=\"#\" class=\"text-danger btn_delete_tax\" data-id=\"";
            // line 55
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["imposto"], "id", [], "any", false, false, false, 55));
            echo "\">Excluir</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
...
";
    ...
    {
        return "/produtos/imposto/list.twig";
    }
    ...
    {
        return new Source("", "/produtos/imposto/list.twig", "C:\\Users\\Diego\\Desktop\\prog\\SoftExpert\\frontend\\app\\views\\produtos\\imposto\\list.twig");
    }
}
