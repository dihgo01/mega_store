...
class __TwigTemplate_68b62e385ca4dd56ed96b64342b8b466 extends Template
{
    ...
    ";
        // line 21
        echo "    ";
        if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["url"] ?? null), "parametros", [], "any", false, false, false, 21), "var1", [], "any", false, false, false, 21) == "franquia") && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["url"] ?? null), "parametros", [], "any", false, false, false, 21), "var2", [], "any", false, false, false, 21) == "vendas"))) {
            // line 22
            echo "        ";
...
";
    ...
    {
        return new Source("", "franquia.twig", "C:\\Users\\Diego\\Desktop\\prog\\SoftExpert\\qv-vitrine\\_V2\\app\\views\\franquia.twig");
    }
}
